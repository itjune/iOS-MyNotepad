...
-(void)makeObjects
{
    self.objects = [NSMutableArray arrayWithArray:[[Data getAllNotes]  allKeys]];
    [self.objects sortUsingComparator:^NSComparisonResult(NSDate * obj1, NSDate * obj2) {
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        [Data removeNoteForKey:[self.objects objectAtIndex:indexPath.row]];
        [Data saveNotes];
